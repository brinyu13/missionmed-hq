...
SF_APP_PORT="${STORYFORGE_INTEGRATION_APP_PORT:-4180}"
SF_EDGE_PORT="${STORYFORGE_INTEGRATION_EDGE_PORT:-4179}"
SF_SERVER_PID=""
SF_EDGE_PID=""
...
EVIDENCE_DIR="$WORKTREE_DIR/_AI_HANDOFFS/from_codex/B1-501_storyforge_v5_integration/evidence"
...
wp user meta update "$MENTOR_ID" _missionmed_storyforge_student_ids '11111111-1111-4111-8111-111111111111'
wp user meta update "$MENTOR_TWO_ID" _missionmed_storyforge_user_id bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb
wp user meta update "$MENTOR_TWO_ID" _missionmed_storyforge_student_ids '11111111-1111-4111-8111-111111111111,22222222-2222-4222-8222-222222222222'
...
wp eval "\$s=mmsf_settings();\$s['storyforge_enabled']=true;\$s['allowed_roles']=array('student','mentor','admin');\$s['allowed_cohorts']=array('2027');\$s['token_ttl_seconds']=5;update_option(MMSF_OPTION,\$s,false);"
