...
# Integration fixture only; production population always comes from WordPress entitlement truth.
...
export STORYFORGE_GATEWAY_SHARED_SECRET="b1-514-local-gateway-signing-secret-32-bytes"
export STORYFORGE_POSTMARK_WEBHOOK_SECRET="b1-514-local-postmark-webhook-secret-32-bytes"
