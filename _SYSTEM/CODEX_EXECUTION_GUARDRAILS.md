...
### 8.1 Required Primer Load (always run first)
...
- `/Users/brianb/MissionMed_AI_Sandbox/_ACTIVITY_LOGS/CODEX/`

Do not use repo `_SYSTEM_LOGS/MM_ACTIVITY_LOG.md` for audit-only, demo-only, or planning-only runs.
