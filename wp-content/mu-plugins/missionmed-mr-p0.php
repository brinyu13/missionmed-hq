...
add_filter('the_content', static function (string $content): string {
    ...
    $route = '<section class="mm-mr-p0-route" aria-label="Mission Residency Fall 2026">'
        ...
        . '<div class="mm-mr-p0-route__card"><span class="mm-mr-p0-route__card-k">Fall 2026 Mission Residency</span><strong>Enrollment is now open.</strong><p>IV Prep Essentials and IV Prep Complet&#101; are accepting students. 360 Match Mentorship capacity is reached for the current cycle.</p><a href="' . esc_url(home_url('/mission-residency/')) . '">View Programs</a></div></div></section>';
