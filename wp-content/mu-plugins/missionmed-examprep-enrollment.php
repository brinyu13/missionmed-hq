...
function mmeep_render_enrollment_experience() {
	...
	<style id="mmeep-styles">
		...
		.mm0921-hero{position:relative;padding:92px 0 66px;background:radial-gradient(circle at 80% 20%,rgba(85,228,206,.14),transparent 31%),linear-gradient(145deg,#051527,#0a2a4d)}.mm0921-hero:after{content:"";position:absolute;inset:auto 0 0;height:1px;background:linear-gradient(90deg,transparent,var(--ep-gold),transparent)}.mm0921-hero-grid{display:grid;grid-template-columns:minmax(0,1.2fr) minmax(300px,.8fr);gap:52px;align-items:center}.mm0921 h1{margin:18px 0 18px;font-size:clamp(44px,6vw,78px);line-height:.98;letter-spacing:-.045em;color:#fff}.mm0921 h1 em{display:block;color:var(--ep-gold);font-style:normal}.mm0921-lede{max-width:720px;margin:0;color:#d8e2ec;font-size:19px;line-height:1.7}.mm0921-hero-card{padding:28px;border:1px solid var(--ep-line);border-radius:24px;background:linear-gradient(150deg,rgba(19,52,88,.92),rgba(5,22,40,.96));box-shadow:0 28px 70px rgba(0,0,0,.28)}.mm0921-hero-card strong{display:block;font-size:20px}.mm0921-hero-card ul{display:grid;gap:13px;margin:20px 0 0;padding:0;list-style:none;color:var(--ep-muted)}.mm0921-hero-card li{display:flex;gap:10px}.mm0921-hero-card li:before{content:"✓";color:var(--ep-teal);font-weight:900}
		...
		.mm0921-media-card img{width:100%;aspect-ratio:16/9;object-fit:cover;display:block}.mm0921-media-card .mm0921-card-body{padding:24px 26px}.mm0921-on-demand-grid{display:grid;grid-template-columns:1.1fr .9fr;gap:24px}.mm0921-lock{opacity:.72;filter:saturate(.75)}.mm0921-lock-mark{display:inline-flex;gap:8px;align-items:center;color:var(--ep-gold);font-size:12px;font-weight:900;letter-spacing:.12em;text-transform:uppercase}.mm0921-mini-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:14px}.mm0921-mini{padding:18px;border:1px solid rgba(255,255,255,.11);border-radius:15px;background:rgba(255,255,255,.035)}.mm0921-mini b{display:block;color:#fff;margin-bottom:5px}.mm0921-mini span{color:var(--ep-muted);font-size:14px;line-height:1.45}
		...
		@media(max-width:900px){.mm0921-hero-grid,.mm0921-product-grid,.mm0921-on-demand-grid{grid-template-columns:1fr}.mm0921-services,.mm0921-compare{grid-template-columns:1fr}.mm0921-method{grid-template-columns:repeat(2,1fr)}}
		@media(max-width:600px){.mm0921-shell{width:min(100% - 28px,1180px)}.mm0921-hero{padding:60px 0 45px}.mm0921 h1{font-size:45px}.mm0921-lede{font-size:17px}.mm0921-tabs{grid-template-columns:1fr}.mm0921-tab{min-height:49px}.mm0921-card-body,.mm0921-schedule{padding:21px}.mm0921-mini-grid,.mm0921-method,.mm0921-faq{grid-template-columns:1fr}.mm0921-actions{display:grid}.mm0921-btn{width:100%}.mm0921-event{grid-template-columns:1fr}.mm0921-section{padding:58px 0}.mm0921-services{grid-template-columns:1fr}.mm0921-price b{font-size:39px}}
	</style>
	<template id="mmeep-template">
		<main class="mm-pg mm0921" data-mmeep-version="<?php echo esc_attr( MMEEP_VERSION ); ?>">
			<section class="mm0921-hero">
