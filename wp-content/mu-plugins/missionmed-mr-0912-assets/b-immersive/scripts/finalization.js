...
$('.hero-copy .actions').insertAdjacentHTML('afterend','<p class="fine">Complete includes Interview Week. Never an additional $500.</p>');
const beats=[
...
const faq=[
['What is Interview Week?','IV Prep Essentials: Interview Week is the live foundation: Orientation + Match Primer, then five training days in communication, content, question strategy, formats, virtual and in-person preparation, program research, and interview follow-through. Tuition is $500.'],
...
['Does Complete include Interview Week?','Yes. Complete includes Interview Week. You never add the $500 Interview Week price to Complete tuition. Choose one program, not both.'],
...
['Does Interview Week include an individual Signature Mock?','No individual Signature Mock Interview is included in the $500 Interview Week tuition. Complete adds a mock and feedback pathway; confirm exact arrangements with Admissions.'],
