...
function compactApplicationIntelligence(application) {
  ...
  const compacted = compactSparse({
    ...
    exams: {
      ...
      step2TimingCode: compactText(application?.exams?.step2TimingCode),
      ...
      step2RequiredForInterview: application?.exams?.step2RequiredForInterview === true,
      step2RequiredBeforeRanking: application?.exams?.step2RequiredBeforeRanking === true,
      step2RequiredBeforeStart: application?.exams?.step2RequiredBeforeStart === true,
      step2TimingConflict: application?.exams?.step2TimingConflict === true,
      step2NoPublishedInitialReviewBarrier: application?.exams?.step2NoPublishedInitialReviewBarrier === true,
      step2TimingNotPublished: application?.exams?.step2TimingNotPublished === true,
      step2Recommended: application?.exams?.step2Recommended === true,
      ...
      comlexAcceptedWithoutUsmle: application?.exams?.comlexAcceptedWithoutUsmle === true,
    ...
    roster: {
      ...
      absence: compactText(roster.absence),
    },
