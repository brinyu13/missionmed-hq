...
`,
  ...
  core = core.replace("This is your canonical Matrix profile rendered in RISE — there is no separate RISE profile truth. Edits here write back through the Matrix profile service; Matrix updates RISE and RISE updates Matrix.", "RISE will render and update the canonical Matrix profile only after an authorized profile adapter is configured. This release creates no duplicate profile truth.");
  core = core.replace("Founder shell: a labeled <b>demo profile</b>. The Matrix profile service contract is Human Gate 3 in the 5001 package.", "Matrix profile integration is unavailable and fails closed. No representative applicant facts are shown.");
  core = core.replace("Founder shell — profile editing writes to Matrix in the real build.", "Matrix profile editing is unavailable in this release.");
  core = core.replace(
