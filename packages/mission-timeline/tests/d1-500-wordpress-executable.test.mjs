...
test("WordPress canary, consent, and JWT seams execute in a bounded harness", () => {
  ...
  assert.deepEqual(receipt.checks, {
    ...
    filevault_v2_internal_nonce_interop: true,
    filevault_historical_version_exact: true,
    filevault_unknown_version_denied: true,
    filevault_historical_cross_owner_denied: true,
    filevault_historical_unconfirmed_denied: true,
    filevault_source_owner_bound: true,
    filevault_source_missing_declared_version_denied: true,
    filevault_source_zero_declared_version_denied: true,
    filevault_source_invalid_declared_version_denied: true,
