...
if(!defined('MMED_PSV_VERSION') || MMED_PSV_VERSION!=='1.4.2' || MMPS_VERSION!=='2026.09.21' || !class_exists('MMPS_Store') || !class_exists('MMPS_Edit')){fwrite(STDERR,"FAIL version collision\n");exit(1);}
require dirname(__DIR__,2).'/wp-content/plugins/missionmed-file-vault-ps/missionmed-file-vault-ps.php';
