...
check( false !== strpos( $files['ui'], 'Download research mission' ) && false !== strpos( $files['ui'], 'Write an Essential version instead' ), 'student wizard keeps downloadable mission and Essential fallback together' );
