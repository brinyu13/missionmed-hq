...
$checks = array(
	...
	'ERAS manifest is versioned canonical JSON' => false !== strpos( $files['rest'], 'missionmed.psv.eras-assignment-manifest.v2' ),
	'MyERAS identity is unresolved rather than guessed' => false !== strpos( $files['rest'], "\$myeras_identity = \$doc['metadata']['myErasIdentity'] ?? null" ) && false !== strpos( $files['rest'], "\$myeras_status = (string) ( \$doc['metadata']['myErasIdentityStatus'] ?? 'UNRESOLVED' )" ) && false !== strpos( $files['rest'], "'assignmentStatus'  => \$assignment_eligible ? 'NOT_STARTED' : 'NEEDS_ATTENTION'" ),
