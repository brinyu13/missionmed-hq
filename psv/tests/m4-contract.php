...
m4check(str_contains($ui, 'PSForge cannot hydrate RISE directly') && str_contains($ui, 'File validated · awaiting RISE acceptance'), 'UI exposes the quarantine and owner boundary', 'Students must see the true state.');
