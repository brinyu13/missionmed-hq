...
ok('only namespaced prototype tables exist besides the stub FV table', JSON.parse(tables).sort().join() === ['wp_mmed_file_vault_stub', 'wp_mmed_ps_proto_audit', 'wp_mmed_ps_proto_edit_revisions', 'wp_mmed_ps_proto_job_items', 'wp_mmed_ps_proto_jobs', 'wp_mmed_ps_proto_library', 'wp_mmed_ps_proto_prompt_versions', 'wp_mmed_ps_proto_provider_attempts', 'wp_mmed_ps_proto_research_artifacts', 'wp_mmed_ps_proto_research_missions', 'wp_mmed_ps_proto_roots', 'wp_mmed_ps_proto_runs', 'wp_mmed_ps_proto_similarity_buckets', 'wp_mmed_ps_proto_similarity_fingerprints'].join(), tables);
