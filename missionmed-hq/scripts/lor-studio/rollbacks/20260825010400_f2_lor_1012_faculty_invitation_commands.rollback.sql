-- Rollback: 20260825010400_f2_lor_1012_faculty_invitation_commands.rollback.sql
-- Authority: F2-LOR-1012 / DR-120 / DR-133
-- Reverses: 20260825010400_f2_lor_1012_faculty_invitation_commands.sql
...
BEGIN
  ...
  expected_sentinel := pg_catalog.format(
    'missionmed.lor.disposable-postgres-harness.v1|database=%s|admin=%s|root=%s|foundation=20260820180700|identityScope=20260825010200|facultyInvitationCommands=20260825010400',
  ...
  IF pg_catalog.current_setting('server_version_num')::integer / 10000 NOT IN (16, 18)
    ...
    OR observed_sentinel IS DISTINCT FROM expected_sentinel THEN
    RAISE EXCEPTION 'DR-133 invitation command rollback requires the exact successor-bound disposable Unix-socket harness identity'
      USING ERRCODE = '42501';
  END IF;
END
$identity_guard$;
