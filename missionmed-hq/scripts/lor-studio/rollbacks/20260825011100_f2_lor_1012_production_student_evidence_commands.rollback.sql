-- Rollback: 20260825011100_f2_lor_1012_production_student_evidence_commands.rollback.sql
-- Authority: F2-LOR-1012 / DR-133
-- Reverses: 20260825011100_f2_lor_1012_production_student_evidence_commands.sql
...
BEGIN
  ...
  THEN
    RAISE EXCEPTION 'DR-133 evidence rollback requires the exact successor-bound private Railway PostgreSQL identity'
      USING ERRCODE = '42501';
  END IF;
END
$identity_guard$;
...
BEGIN
  ...
  EXECUTE pg_catalog.format(
    ...
    pg_catalog.regexp_replace(
      observed_sentinel, '\|studentEvidenceCommands=20260825011100$', ''
    )
  );
END
$restore_sentinel$;
