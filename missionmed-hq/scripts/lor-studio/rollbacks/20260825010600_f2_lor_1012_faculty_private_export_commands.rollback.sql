-- Rollback: 20260825010600_f2_lor_1012_faculty_private_export_commands.rollback.sql
-- Authority: F2-LOR-1012 / DR-133
-- Reverses: 20260825010600_f2_lor_1012_faculty_private_export_commands.sql
...
BEGIN
  ...
  expected_sentinel := pg_catalog.format(
    'missionmed.lor.disposable-postgres-harness.v1|database=%s|admin=%s|root=%s|foundation=20260820180700|identityScope=20260825010200|facultyInvitationCommands=20260825010400|facultyPrivateExportCommands=20260825010600',
  ...
  THEN
    RAISE EXCEPTION 'DR-133 faculty-private/export rollback requires the exact successor disposable harness identity'
      USING ERRCODE = '42501';
  END IF;
END
$identity_guard$;
...
BEGIN
  ...
  EXECUTE pg_catalog.format(
    ...
    pg_catalog.regexp_replace(
      observed_sentinel,
      '\|facultyPrivateExportCommands=20260825010600$',
      ''
    )
  );
END
