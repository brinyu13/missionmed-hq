-- Rollback: 20260826010700_f2_lor_1012_live_production_faculty_private_export_commands.rollback.sql
-- Authority: F2-LOR-1012 / DR-133
-- Reverses: 20260826010700_f2_lor_1012_live_production_faculty_private_export_commands.sql
...
BEGIN
  ...
  EXECUTE pg_catalog.format(
    ...
    pg_catalog.regexp_replace(
      observed_sentinel,
      '\|facultyPrivateExportCommands=20260826010700$',
      ''
    )
  );
END
