-- Migration: 20260825011000_f2_lor_1012_student_evidence_commands.sql
-- Authority: F2-LOR-1012 / DR-133
-- Date: 2026-08-26
-- Depends on: 20260825010800_f2_lor_1012_ai_proposal_commands.sql
...
BEGIN
  ...
  THEN
    RAISE EXCEPTION 'DR-133 evidence command migration requires the exact AI-successor disposable harness identity'
      USING ERRCODE = '42501';
  END IF;
END
$identity_guard$;
