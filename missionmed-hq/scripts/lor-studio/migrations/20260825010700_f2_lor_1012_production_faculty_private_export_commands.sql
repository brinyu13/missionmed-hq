-- Migration: 20260825010700_f2_lor_1012_production_faculty_private_export_commands.sql
-- Authority: F2-LOR-1012 / DR-133
-- Date: 2026-08-25
-- Depends on: 20260825010500_f2_lor_1012_production_faculty_invitation_commands.sql
...
BEGIN
  ...
  expected_sentinel := pg_catalog.format(
    'missionmed.lor.railway-postgres-target.v1|provider=%s|project=%s|environment=%s|service=%s|database=%s|admin=%s|region=%s|decision=%s|dataCopied=%s|foundation=20260825010000|identityScope=20260825010300|facultyInvitationCommands=20260825010500',
    target_provider,
    target_project_id,
    target_environment_id,
    target_service_id,
...
BEGIN
  ...
  EXECUTE pg_catalog.format(
    ...
    observed_sentinel || '|facultyPrivateExportCommands=20260825010700'
  );
END
$advance_sentinel$;
