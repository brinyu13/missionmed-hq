-- Migration: 20260825010800_f2_lor_1012_ai_proposal_commands.sql
-- Authority: F2-LOR-1012 / DR-133
-- Date: 2026-08-25
-- Depends on: 20260825010600_f2_lor_1012_faculty_private_export_commands.sql
...
BEGIN
  ...
  THEN
    RAISE EXCEPTION 'DR-133 AI proposal command migration requires the exact export-successor disposable harness identity'
      USING ERRCODE = '42501';
  END IF;
END
$identity_guard$;
