-- Migration: 20260825010100_f2_lor_1012_production_rls_projection_grants.sql
-- Authority: F2-LOR-1012 / DR-133
-- Date: 2026-08-25
-- Depends on: 20260825010000_f2_lor_1012_production_schema_foundation.sql
...
BEGIN
  ...
  IF expected_index_fingerprint IS NULL
    ...
    OR observed_rls IS DISTINCT FROM (
      SELECT pg_catalog.array_agg(relation_name || ':false:false' ORDER BY relation_name)
