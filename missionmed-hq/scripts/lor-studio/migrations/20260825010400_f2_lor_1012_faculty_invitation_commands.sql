-- Migration: 20260825010400_f2_lor_1012_faculty_invitation_commands.sql
-- Authority: F2-LOR-1012 / DR-120 / DR-133
-- Date: 2026-08-25
-- Depends on: 20260825010200_f2_lor_1012_identity_scope_commands.sql
...
BEGIN
  ...
  THEN
    RAISE EXCEPTION 'DR-133 invitation command migration requires the exact successor-bound disposable Unix-socket harness identity'
      USING ERRCODE = '42501';
  END IF;
END
$identity_guard$;
...
BEGIN
  ...
  EXECUTE pg_catalog.format(
    ...
    observed_sentinel || '|facultyInvitationCommands=20260825010400'
  );
END
$advance_sentinel$;
