-- Migration: 20260825010000_f2_lor_1012_production_schema_foundation.sql
...
BEGIN
  ...
  IF target_provider IS DISTINCT FROM 'railway-postgres'
...
DECLARE
  ...
  sentinel text;
BEGIN
  sentinel := 'missionmed.lor.railway-postgres-target.v1'
