-- Migration: 20260826010100_f2_lor_1012_live_production_rls_projection_grants.sql
-- Authority: F2-LOR-1012 / DR-133
-- Date: 2026-08-26
-- Depends on: 20260826010000_f2_lor_1012_live_production_schema_foundation.sql
...
BEGIN
  ...
  THEN
    RAISE EXCEPTION 'DR-133 RLS migration requires the exact sentinel-bound private Railway PostgreSQL target identity'
      USING ERRCODE = '42501';
  END IF;
END
$identity_guard$;
