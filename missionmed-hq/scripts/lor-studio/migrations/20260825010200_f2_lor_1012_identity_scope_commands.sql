-- Migration: 20260825010200_f2_lor_1012_identity_scope_commands.sql
-- Authority: F2-LOR-1012 / DR-133
-- Date: 2026-08-25
-- Depends on: 20260820180800_f2_lor_1012_rls_projection_grants.sql
...
BEGIN
  ...
  THEN
    RAISE EXCEPTION 'DR-133 identity/scope migration requires the exact sentinel-bound disposable Unix-socket harness identity'
      USING ERRCODE = '42501';
  END IF;
END
$identity_guard$;
...
BEGIN
  ...
  EXECUTE pg_catalog.format(
    ...
    observed_sentinel || '|identityScope=20260825010200'
  );
END
$advance_sentinel$;
