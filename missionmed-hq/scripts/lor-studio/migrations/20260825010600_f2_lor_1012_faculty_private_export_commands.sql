-- Migration: 20260825010600_f2_lor_1012_faculty_private_export_commands.sql
-- Authority: F2-LOR-1012 / DR-133
-- Date: 2026-08-25
-- Depends on: 20260825010400_f2_lor_1012_faculty_invitation_commands.sql
...
BEGIN
  ...
  THEN
    RAISE EXCEPTION 'DR-133 faculty-private/export migration requires the exact invitation-successor disposable harness identity'
      USING ERRCODE = '42501';
  END IF;
END
$identity_guard$;
...
BEGIN
  ...
  EXECUTE pg_catalog.format(
    ...
    observed_sentinel || '|facultyPrivateExportCommands=20260825010600'
  );
END
$advance_sentinel$;
