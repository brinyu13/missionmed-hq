-- Migration: 20260826010500_f2_lor_1012_live_production_faculty_invitation_commands.sql
-- Authority: F2-LOR-1012 / DR-120 / DR-133
-- Date: 2026-08-26
-- Depends on: 20260826010300_f2_lor_1012_live_production_identity_scope_commands.sql
...
BEGIN
  ...
  expected_sentinel := pg_catalog.format(
    'missionmed.lor.railway-postgres-target.v2|deploymentEnvironment=production|migrationLedger=lor_studio/migrations/production|provider=%s|project=%s|environment=%s|service=%s|database=%s|admin=%s|region=%s|decision=%s|dataCopied=%s|foundation=20260826010000|identityScope=20260826010300',
    target_provider,
    target_project_id,
    target_environment_id,
    target_service_id,
...
BEGIN
  ...
  EXECUTE pg_catalog.format(
    ...
    observed_sentinel || '|facultyInvitationCommands=20260826010500'
  );
END
$advance_sentinel$;
