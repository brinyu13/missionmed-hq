...
function actionDialogMarkup({ needsConsent, danger }) {
  return `<style>
    ...
    #missionaccountsPaymentConfirm{background:${danger ? '#a12622' : 'linear-gradient(90deg,#105f40,#0d563a)'}!important;border-color:${danger ? '#a12622' : '#0d563a'}!important;color:#fff!important}
